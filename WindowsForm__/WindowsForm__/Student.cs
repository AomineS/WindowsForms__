...
namespace WindowsForm__
{
    ...
    class Student : Human
    {
        ...
        public Student(string name, string surname, int age, Gender gender, Nation nation, Adress adress, string email, int group, int money, Key key) : base(name, surname,
